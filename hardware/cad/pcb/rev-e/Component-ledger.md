# Alfred revision E component ledger
...
Pi/audio protected rail, about2.02A nominal current limit, with slower startup for2200uF reservoir.
...
## R101 - 1.65k 0.1%
MPN: RT0805BRD071K65L. Footprint: Resistor_SMD:R_0805_2012Metric.
Pi/audio overcurrent setting about 2.02A nominal, 1.8-2.2A datasheet limits before resistor tolerance. Intended rail load <=1.65A.
Pins: 1=PI_ILM, 2=GND
...
## C101 - 10n
MPN: C0805C103J5GACTU. Footprint: Capacitor_SMD:C_0805_2012Metric.
Slows Pi/audio startup to about25.5ms nominal; reduces2200uF reservoir charging surge to about0.44A nominal.
...
1% supervisor; nominal4.8300V falling and4.8594V rising;107ms nominal qualification and asynchronous arm-latch clear.
Pins: 1=UV_SENSE, 2=GND, 3=PI_3V3, 4=PI_3V3, 5=UV_DELAY, 6=SUPPLY_OK

## R107 - 32.0k 0.1%
MPN: RT0805BRD0732KL. Footprint: Resistor_SMD:R_0805_2012Metric.
Verified catalog 32k 0.1% supervisor top resistor; nominal fall 4.8300V, rise 4.8594V.
...
DO NOT FIT in revision E: floating GAIN_SLOT selects 9 dB. Optional 100k to VDD selects quiet 3 dB mode.

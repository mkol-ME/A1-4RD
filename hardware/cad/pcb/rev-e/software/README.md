...
- Start at -12 dBFS or lower for speech and raise only after testing. Revision E's 9 dB hardware gain can approach the speaker's 3 W rating at full scale, but clean output depends on supply and load. The smoke test uses -30 dBFS.

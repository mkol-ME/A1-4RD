# Alfred mechanical interface — millimetres, revision E
...
Revision E retains all fixed mechanical coordinates. The three small protection parts occupy existing low-height circuitry space; the connector stack and enclosure dimensions are unchanged.

# Alfred revision E fabrication and assembly
...
## Revision E population

R107 is 32.0k 0.1%, RT0805BRD0732KL. R101 is 1.65k 0.1%, RT0805BRD071K65L. C101 is 10nF C0G 5%, C0805C103J5GACTU. All three use their existing 0805 footprints. The PCB connectivity and component positions are unchanged from revision D.

U4 remains TPS389001DSET, U11 remains Nexperia 74AUP1G74DC,125, and Q1/Q2 remain SI4459BDY-T1-GE3. Do not substitute generic logic families. R304 remains DO NOT FIT with no stencil apertures. Use the updated BOM and the power acceptance limits.
...
Gerber job Size is normalized to the 120 x 94 mm outline centerline. KiCad export includes the 0.1 mm outline stroke; normalize Size after re-export.

Revision E fault test: hold GPIO22 HIGH, induce a detected undervoltage event, restore the rail, and confirm servo power stays OFF. After supply-good is stable, bring GPIO22 LOW for at least 10 ms, then HIGH to re-arm. Test with a current-limited load before fitting the linkage.

Revision E: Pi/audio startup is now about25.5ms nominal; servo startup remains about12ms. Follow Power-acceptance.md before claiming combined-load operation.

# Alfred mechanical interface — millimetres, revision D
...
Revision D retains all fixed mechanical coordinates. The three small protection parts occupy existing low-height circuitry space; the connector stack and enclosure dimensions are unchanged.

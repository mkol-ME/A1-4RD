# Alfred revision D fabrication and assembly
...
## Revision D population

U4 is TPS389001DSET: its footprint and pin functions changed. Q1/Q2 are SI4459BDY-T1-GE3. R107 is 32.1k 0.1%; R109 is 2.2k 1%; C111 is 100n. Fit U11=74AUP1G74DC,125 and C112=100n. U11 pin 3 is unconnected. Do not substitute a generic 74LVC1G74. Check markings and pin-1 orientation before reflow.

R304 remains DO NOT FIT and now uses a pinned no-paste footprint. Its apertures are removed from the supplied stencil Gerber. R114/R115 and D101 retain the EN protection from revision C. Other circuit components remain fitted.
...
Revision D fault test: hold GPIO22 HIGH, induce a detected undervoltage event, restore the rail, and confirm servo power stays OFF. After supply-good is stable, bring GPIO22 LOW for at least 10 ms, then HIGH to re-arm. Test with a current-limited load before fitting the linkage.

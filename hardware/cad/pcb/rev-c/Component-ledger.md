# Alfred revision C component ledger
...
## Q1 - FDS6673BZ
MPN: FDS6673BZ. Footprint: Package_SO:SO-8_3.9x4.9mm_P1.27mm.
30 V common-source P-channel switch; max 12 milliohm at VGS=-4.5 V, 25 C. Verify startup SOA and temperature.
...
## U4 - TLV3012BIDBVR
MPN: TLV3012BIDBVR. Footprint: Package_TO_SOT_SMD:SOT-23-6.
B variant tolerates input when unpowered. Hardware UV comparator with hysteresis.
Pins: 1=SUPPLY_OK, 2=GND, 3=UV_SENSE, 4=UV_REF, 5=UV_REF, 6=PI_3V3

## R107 - 29.8k 0.1%
MPN: RT0805BRD0729K8L. Footprint: Resistor_SMD:R_0805_2012Metric.
Sense protected Pi rail; nominal external-hysteresis thresholds 4.960 V rising / 4.915 V falling. Intrinsic hysteresis and tolerances add uncertainty.
...
## R109 - 2.2M 1%
MPN: RC0805FR-072M2L. Footprint: Resistor_SMD:R_0805_2012Metric.
Positive feedback; ideal external-hysteresis thresholds 4.960 V on / 4.915 V off with revision C R107. Intrinsic hysteresis, offset and tolerances require measurement.
Pins: 1=SUPPLY_OK, 2=UV_SENSE
...
Hardware AND: supervisor overrides software request.
Pins: 1=SUPPLY_OK, 2=SERVO_REQUEST, 3=GND, 4=SERVO_EN, 5=PI_3V3
...
Reference bypass, C0G. Below the TLV3012 reference 10nF capacitive-load stability limit.
Pins: 1=UV_REF, 2=GND
...
## R304 - 100k 1%
MPN: RC0805FR-07100KL. Footprint: Resistor_SMD:R_0805_2012Metric.
DO NOT FIT in revision C: floating GAIN_SLOT selects 9 dB. Optional 100k to VDD selects quiet 3 dB mode.

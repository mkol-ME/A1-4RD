# A1-4RD / Alfred — printable prototype, revision B
...
## Revision B: classical bust silhouette and BTAS facial details

The torso now has broad upper shoulders, a tapered chest and an integral short oval socle inspired by the supplied classical bust photograph. Alfred retains a formal shirt, pointed tuxedo lapels, bow tie and shirt studs. The original head/socket position, 202 mm overall height, base attachment and PCB enclosure dimensions are preserved. The torso includes a continuous 18 x 16 mm wiring passage through the pedestal.

The head revision trims the long ears into compact lobed ears with shallow inner recesses, adds raised receding side-hair volumes, and sharpens the pointed moustache. The bald crown, solid eyes and reinforced jaw frame remain. These facial features are integral prints.

Reference: original user Alfred BTAS image, supplemented by [The World's Finest Alfred reference gallery](https://dcanimated.com/batribute/batribute-characters/batribute-characters-alfred-index2/).

The new torso has a front-neck relief for the moving chin. The rear neck and socket floor retain the head support; route and secure the neck service loop behind the moving chin.
